...
<!-- begin breadcrumb -->
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Administrar contadores <small>Editar Contador</small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
    <div class="panel panel-default">
        ...
        <div class="panel-heading">
            ...
            <div class="panel-heading-btn">
                <a href="{!! route('contadores.index') !!}" class="btn btn-info btn-sm"><i class="fa fa-arrow-alt-circle-left"></i> Regresar</a>
            </div>
        </div>
        <!-- end panel-heading -->
        <!-- begin panel-body -->
...
@push('scripts')
    <script>
        $(document).ready(function(){
            $("#id").val('{{ $contador->id }}');
            $("#anio").val('{{ $contador->anio }}');
            $("#contador").val('{{ $contador->contador }}');
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    $("#centro_id").val('{{ $contador->centro_id }}').trigger("change");
                }
            });
            $.ajax({
                ...
                success:function(data){
                    ...
                    $("#tipo_contador_id").val('{{ $contador->tipo_contador_id }}').trigger('change');
                }
            });
        });
