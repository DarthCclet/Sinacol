...
@section('content')
    ...
    <a href="/asesoria/1010101010/?origen={{$origen}}" id="btn-calculo" class="btn btn-primary btn-lg m-10 float-right" type="button">Siguiente</a>
    ...
    @elseif($origen == '10501010')
        ...
        <a href="/asesoria/101010101010/?origen={{$origen}}" id="btn-calculo" class="btn btn-primary btn-lg m-10 float-right" type="button">Siguiente</a>
    @endif
    <script>
