...
{!! Form::open([ 'route' => 'plantilla-documentos.store' ]) !!}
  ...
  <div class="panel panel-default">
      ...
      <div class="panel-heading">
          ...
          <div class="panel-heading-btn">
              <a href="{!! route('plantilla-documentos.index') !!}" class="btn btn-info btn-sm"><i class="fa fa-arrow-alt-circle-left"></i> Regresar</a>
          </div>
      </div>
