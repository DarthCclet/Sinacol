...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Administrar tipos de contactos <small>Editar {{$tipo->nombre}}</small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
{{ Form::model($tipo, array('route' => array('tipos_contactos.update', $tipo->id), 'method' => 'PUT')) }}
