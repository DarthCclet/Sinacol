...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">Administrar grupos prioritarios <small>Editar</small></h1>
<!-- end page-header -->

<!-- begin panel -->
{!! Form::model($grupoPrioritario, ['route' => ['grupo-prioritario.update', $grupoPrioritario->id], 'method' => 'PUT'] ) !!}
    <div class="panel panel-default">
        <!-- begin panel-heading -->
        <div class="panel-heading">
            <h4 class="panel-title">Nuevo</h4>
            <div class="panel-heading-btn">
                <a href="{!! route('grupo-prioritario.index') !!}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-alt-circle-left"></i> Regresar</a>
            </div>
        </div>
        <!-- end panel-heading -->
        <!-- begin panel-body -->
