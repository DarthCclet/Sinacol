...
@section('title', 'Jornadas de conciliación')
...
@section('content')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Administrar jornadas de conciliación <small>Listado de jornadas</small></h1>
    <!-- end page-header -->
    <!-- begin panel -->
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @include('catalogos.jornadas._list')
        </div>
    </div>
