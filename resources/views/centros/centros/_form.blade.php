<div class="row">
    <div class=" col-md-4 ">
        <div class="form-group">
            ...
            {!! Form::text('centro[nombre]', isset($centro) ? $centro->nombre : null, ['class'=>'form-control', 'id'=>'nombre', 'placeholder'=>'Centro', 'autofocus'=>true]) !!}
    ...
    <div class=" col-md-4 ">
        <div class="form-group">
            ...
            {!! Form::text('centro[abreviatura]', isset($centro) ? $centro->abreviatura : null, ['class'=>'form-control', 'id'=>'abreviatura', 'placeholder'=>'Abreviatura', 'size'=>'10', 'autofocus'=>true]) !!}
    ...
    <div class=" col-md-4 ">
        <div class="form-group">
            ...
            {!! Form::text('centro[duracionAudiencia]', isset($centro) ? $centro->duracionAudiencia : null, ['class'=>'form-control', 'id'=>'duracionAudiencia', 'placeholder'=>'Duración', 'size'=>'10', 'autofocus'=>true]) !!}
