	...
	<div data-scrollbar="true" data-height="100%">
			...
			<li class="nav-profile">
				<a href="javascript:;" data-toggle="nav-profile">
					...
					<div class="info">
						...
						{{isset($user->full_name)?:'Nombre Default'}}
						<small>{{isset($user->rol)?:'Rol default'}}</small>
					</div>
				</a>
			</li>
			<li>
				<ul class="nav nav-profile">
					<li><a href="javascript:;"><i class="fa fa-pencil-alt"></i> Modificar mis datos</a></li>
				</ul>
			</li>
		</ul>
		<!-- end sidebar user -->
		...
		<ul class="nav">
			...
			@php
                ...
                if(App::environment('local') && in_array('guitest', $ruta->middleware())){
                    $menuChildren = config('sidebar.menu');
                }
				...
				foreach ($menuChildren as $key => $menu) {
