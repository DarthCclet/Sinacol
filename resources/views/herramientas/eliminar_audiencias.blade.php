...
<div class="panel panel-default" style="margin: 0 5% 0 5%;">
    ...
    <div class="panel panel-default" id="nueva-incidencia" >
        ...
        <div class="panel-heading">
            <h4 class="panel-title">Selecciona la solicitud relacionada al proceso</h4>
                ...
                <div id="divSolicitud" >
                    ...
                    <div id="SolicitudInfo" class="card col-md-8 offset-2" style="margin-top: 5%;">
                        ...
                        <div style="display: none; margin: 2%;" class="col-md-12 row" id="divBtnSol" >
                            <h1 > Proceso a realizar: <span style="color: {{config('colores.btn-primary-color')}};" id="labelInfoAudiencia"></span></h1>
                            <div class="col-md-12 row">
                                <button class="btn btn-primary" style="margin-left: 1%;" id="btnEjecutar" onclick="eliminarAudiencia()">Ejecutar proceso</button>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
                    ...
                    try{
                        if(json.success){
                            ...
                            if(data.audiencias && data.audiencias.length > 1){
                                ...
                                $("#labelInfoAudiencia").html("La solicitud solo tiene una audiencia, no se puede realizar este proceso");
                            }
                            if(data.expediente){
                                solicitudObj.expediente = data.expediente.folio;
                            }else{
                                solicitudObj.expediente = "";
                                $("#labelInfoAudiencia").html("La solicitud no esta confirmada, no se puede realizar este proceso");
                            }
    ...
    function formatoAudiencia(){
        ...
        if(audiencia.finalizada){
            $("#labelInfoAudiencia").html("No se puede realizar proceso ya que la audiencia ya esta finalizada");
        }else if(audiencia.iniciada){
            $("#labelInfoAudiencia").html("No se puede realizar proceso ya que la audiencia ya esta iniciada");
        }else{
            $("#labelInfoAudiencia").html("Eliminar audiencia: "+audiencia.folio + "/" + audiencia.anio);
        }
