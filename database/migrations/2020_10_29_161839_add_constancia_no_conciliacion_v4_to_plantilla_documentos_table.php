...
class AddConstanciaNoConciliacionV4ToPlantillaDocumentosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        <tr style="height: 21px; text-align: center;">
        <td style="width: 96.1515%; line-height: 8pt; height: 14px; text-align: center;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">Centro Federal de Conciliaci&oacute;n y Registro Laboral</span></td>
        ...
        <p style="text-align: center;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;"><strong>CONSTANCIA DE NO CONCILIACI&Oacute;N</strong></span></p>
        <p style="line-height: 6pt;">&nbsp;</p>
        <p style="line-height: 8pt;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;"><strong>Solicitante: <strong class="mceNonEditable" data-nombre="solicitante_nombre_completo">[SOLICITANTE_NOMBRE_COMPLETO]</strong>&nbsp; </strong></span></p>
        <p style="line-height: 8pt;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;"><strong>Citado(a): <strong class="mceNonEditable" data-nombre="solicitado_nombre_completo">[SOLICITADO_NOMBRE_COMPLETO]</strong>&nbsp; &nbsp;</strong></span></p>
        ...
        <p style="line-height: 11pt;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;"><strong>Motivaci&oacute;n:&nbsp;</strong>Falta de acuerdo entre los interesados para negociar las prestaciones que derivan de la rescisi&oacute;n del contrato de trabajo</span></p>
        ...
        <p style="line-height: 11pt; text-align: center;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;"><strong><strong class="mceNonEditable" data-nombre="conciliador_qr_firma">[CONCILIADOR_QR_FIRMA]</strong>&nbsp; </strong></span></p>
