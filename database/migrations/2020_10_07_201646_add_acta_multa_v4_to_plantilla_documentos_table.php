...
class AddActaMultaV4ToPlantillaDocumentosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::table('plantilla_documentos')->where('nombre_plantilla','ACTA DE MULTA')->update(
            [
              ...
              <p style="text-align: justify;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">Vista la certificaci&oacute;n mencionada, se advierte que la parte citada <strong class="mceNonEditable" data-nombre="solicitado_nombre_completo">[SOLICITADO_NOMBRE_COMPLETO]</strong></span><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">, <strong>no compareci&oacute; a la audiencia de conciliaci&oacute;n</strong> prevista a las <strong class="mceNonEditable" data-nombre="audiencia_hora_inicio">[AUDIENCIA_HORA_INICIO]</strong> horas de esta misma fecha, a pesar de encontrarse debidamente notificado(a) para tal efecto, circunstancia que se corrobora con la constancia de notificaci&oacute;n de <strong class="mceNonEditable" data-nombre="solicitud_fecha_ratificacion">[SOLICITUD_FECHA_RATIFICACION]</strong>.</span></p>
              ...
              <p style="text-align: justify;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">En este acto, <strong>se hace efectivo el apercibimiento decretado</strong> en el citatorio notificado el <strong class="mceNonEditable" data-nombre="solicitud_fecha_ratificacion">[SOLICITUD_FECHA_RATIFICACION]</strong> y se impone a la parte citada <strong class="mceNonEditable" data-nombre="solicitado_nombre_completo">[SOLICITADO_NOMBRE_COMPLETO]</strong> </span><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">&nbsp;una multa m&iacute;nima por el monto de cincuenta veces la Unidad de Medida y Actualizaci&oacute;n.</span></p>
