...
class AddCitatorioV4ToPlantillaDocumentosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::table('plantilla_documentos')->where('nombre_plantilla','CITATORIO DE CONCILIACIÓN')->update(
            ...
            <p style="text-align: justify;"><span style="font-family: Montserrat, sans-serif; font-size: 12pt;">En cumplimiento y observancia a la fracci&oacute;n XX, del art&iacute;culo 123 Constitucional, apartado A; as&iacute; como los de los Principios Procesales contenidos en los art&iacute;culos 684-E y 685 de la Ley Federal del Trabajo, que regulan el procedimiento obligatorio prejudicial conciliatorio; se le cita al <strong>C. REPRESENTANTE LEGAL DE:</strong> <strong class="mceNonEditable" data-nombre="solicitado_nombre_completo">[SOLICITADO_NOMBRE_COMPLETO]</strong> para que asista a la <strong>Audiencia de Conciliaci&oacute;n</strong> de fecha <strong class="mceNonEditable" data-nombre="audiencia_fecha_audiencia">[AUDIENCIA_FECHA_AUDIENCIA]</strong> a las <strong class="mceNonEditable" data-nombre="audiencia_hora_inicio">[AUDIENCIA_HORA_INICIO]</strong> horas, en la <strong class="mceNonEditable" data-nombre="sala_nombre">[SALA_NOMBRE]</strong>&nbsp;de la oficina de representaci&oacute;n <strong class="mceNonEditable" data-nombre="centro_nombre">[CENTRO_NOMBRE]</strong> del Centro Federal de Conciliaci&oacute;n y Registro Laboral.</span></p>
