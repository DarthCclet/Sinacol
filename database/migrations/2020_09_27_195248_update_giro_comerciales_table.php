...
class UpdateGiroComercialesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $workbook = SpreadsheetParser::open($path . "/ClasificacionSCIANporCompetencia.xlsx", 'xlsx');
