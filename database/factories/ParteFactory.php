...
$factory->define(Parte::class, function (Faker $faker) {
    ...
    return [
        ...
        'nombre' => ($tipo_persona->abreviatura == 'F') ? strtoupper($faker->firstName) : null,
        'primer_apellido' => ($tipo_persona->abreviatura == 'F') ? strtoupper($faker->lastName) : null,
        'segundo_apellido' => ($tipo_persona->abreviatura == 'F') ? strtoupper($faker->lastName) : null,
        'nombre_comercial' => ($tipo_persona->abreviatura == 'M') ? strtoupper($faker->company) : null,
...
$factory->state(Parte::class, 'representanteLegal', function (Faker $faker) {
    ...
    return [
        ...
        'genero_id' => ($tipo_persona->abreviatura == 'F') ? $genero->id : null,
        'tipo_parte_id' => $tipo_parte->id,
        'instrumento' => strtoupper($faker->firstName),
        'feha_instrumento'=>$faker->dateTime,
        'numero_notaria'=>$faker->randomNumber(3),
        'nombre_notario' => strtoupper($faker->firstName) . " " . strtoupper($faker->lastName),
