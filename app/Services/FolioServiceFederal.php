...
class FolioServiceFederal implements FolioService
{
     ...
     */
    public function getFolio($parametros): array
    {
     ...
     * @throws CentroNoValidoException
     */
    protected function abreviaturaCentro($centro_id) : string
    {
        // Abreviatura del centro
     ...
     * @param $tipo_solicitud_id
     * @return mixed
     * @throws TipoSolicitudNoValidaException
     */
    protected function siglasTipoSolicitud($tipo_solicitud_id): string
    {
